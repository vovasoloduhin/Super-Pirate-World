...
class Game:
	...
	def show_game_over_screen(self):
		self.display_surface.fill((30, 0, 0))
		font = pygame.font.Font(pygame.font.match_font('freesansbold'), 36)
		text_surf = font.render("Ви програли! Натисніть R щоб почати заново", True, (255, 100, 100))
			...
			for event in pygame.event.get():
				...
				if event.type == pygame.KEYDOWN and event.key == pygame.K_r:
					...
					self.current_stage = Level(self.tmx_maps[self.data.current_level], self.level_frames,
											   self.audio_files, self.data, self.switch_stage)
					waiting = False
